        ...
        <div className={styles.facilities}>
            <div className={styles.facilitiesContainer}>
                ...
                <div className={styles.facilityImageFirstCollection}>
                    <img src='/ASP/images/Machine.png' alt='products main' width='48.3%' height="45%" />
                    <img src='/ASP/images/dabbalobokka.png' alt='products main' width='48.3%' height="100%" />
                </div>
                ...
                <Separator />
                <img src='/ASP/images/equipmentshowcase.png' alt='products main' width='100%' height="100%" />
                ...
                <div className={styles.imagesCollection}>
                    <img src='/ASP/images/facility-collection.png' alt='' width='100%' height='100%'/>
                </div>
                ...
                <div className={styles.imagesCollectionTwo}>
                    <img src='/ASP/images/tisAfridge.png' alt='' width='49.34%' height='100%'/>
                    <img src='/ASP/images/notafridge.png' alt='' width='49.34%' height='100%'/>
                </div>
