    ...
    return (
        <div className={styles.dustMitigation}>
            <div className={styles.dustTopContainer}>
                ...
                <img src='/ASP/images/DustMain.png' alt='main' width='100%' height="100%"/>
                ...
                <div className={styles.textAfterCollection}>
                    <img src='/ASP/images/Truck&Space.png' alt='collection' width='100%' height="100%"/>
                    <p>
                ...
                <div className={styles.dustEffectivenessFilter}>
                    <img src='/ASP/images/removeparticlesgraph.png' alt='collection' width='100%' height="100%"/>
                    <p>
