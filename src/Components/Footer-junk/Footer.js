            ...
            <div className='footer-container'>
                ...
                <div className='footer-right-container'>
                    ...
                    <div className='footer-right'>
                        <a href='tel:7812197625' className='contacts'> <i className='fa fa-phone-alt'/> Phone: (781)-219-7625</a>
                        ...
                        <a href="mailto:office@analyticalscientificproducts.com" className='contacts'><i className='fa fa-envelope' /> Email: office@analyticalscientificproducts.com</a>
